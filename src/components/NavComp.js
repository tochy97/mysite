...
function NavComp(props) {
    ...
    return (
        <nav id="nav" class="fixed top-0 left-0 right-0 opacity-100 bg-black text-white border-solid border-b-2 border-gray-300 grid grid-cols-3 gap-0 shadow-md w-full py-7 z-20">
