...
function Footer() {
    return (
        <footer id="footer" class="fixed bottom-0 left-0 right-0 w-full bg-black text-white border-solid border-t-2 border-gray-300 grid grid-col-3 gap-1 z-20 transition ease-in-out delay-150 justify-items-center">
