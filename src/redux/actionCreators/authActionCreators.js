...
export const checkUser = ()  => async dispatch=>{
    await axios.get('https://54.85.226.96:8000/currentuser/', {
        headers: {
...
export const loginUser = (data) => async dispatch=>{
    ...
    await axios.post("https://54.85.226.96:8000/auth/", formData, {
        headers: {
...
export const createUser = (data) =>  async dispatch=>{
    const formData = JSON.stringify(data)
    await axios.post("https://54.85.226.96:8000/createuser/", formData, {
        headers: {
            'Content-Type': 'application/json',
        },
    })
...
export const updateUser = ( data, id ) => async dispatch => {
    ...
    await axios.put(`https://54.85.226.96:8000/userapi/${id}/`, form_data, {
        headers:{
            Authorization: `JWT ${localStorage.getItem('token')}`,
            'Content-Type': 'application/json',
        }
