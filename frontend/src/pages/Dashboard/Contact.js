  ...
  return (
    <>
        ...
        <form class="grid gap-4 grid-cols-6" onSubmit={sendEmail}>
            <input type="hidden" name="contact_number" class="border border-gray-500 rounded py-3 px-4 mb-3 lg:col-start-3 lg:col-span-2 col-start-2 col-span-4"/>
            ...
            <textarea type="text" name="subject" placeholder='Your message'  class="border border-gray-500 rounded py-3 px-4 mb-3 lg:col-start-3 lg:col-span-2 col-start-2 col-span-4"/>
            <textarea name="html_message" />
            <input  class="border border-gray-300 rounded py-3 mb-3 lg:col-start-3 lg:col-span-2 col-start-2 col-span-4 hover:border-2 hover:underline underline-offset-8"  type="submit" value="Send" />
        </form>
    </>
  );
}