...
function Nav(props) {
    ...
    return (
        <nav id="nav" class="fixed top-0 left-0 right-0 w-full opacity-100 bg-gray-600 text-white border-solid border-b-2 border-gray-300 grid grid-cols-3 gap-0 shadow-md py-7 z-20">
            ...
            <div id="nav-home" class="flex justify-center">
                <img src={logo} class="ease-in-out duration-700 w-10 hover:rotate-180"/>
            </div>
            {
                user
                ?
