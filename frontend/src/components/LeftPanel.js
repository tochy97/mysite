            ...
            ?
                <OutsideClickHandler onOutsideClick={() => { setExpanded(false) }}>
                    <div id="left-panel" class="fixed left-0 flex-none w-auto border-r-2 border-solid border-gray-200 top-20 h-full z-10 bg-white grid grid-col-2 shadow-xl">
                        <div id="left-panel-content" class="col-start-1 col-span-1 flex flex-col mt-6"  {...getCollapseProps()}>
                        ...
                        <button  id="left-panel-toggle" class="col-start-2 col-span-1 justify-self-end" onClick= {() => setExpanded((prevExpanded) => !prevExpanded)}>
